        ...
        {jobs?.map((job, index) => {
          ...
          return (
            <div
              ...
              className="@container animate-slide-up group cursor-pointer rounded-xl border border-border bg-card warm-shadow transition-all duration-200 hover:-translate-y-0.5 hover:border-primary/30 hover:warm-shadow-md active:translate-y-0 active:shadow-sm"
              style={{ animationDelay: `${index * 0.04}s` }}
            >
              <div className="flex gap-4 p-4 @sm:p-5">
                <div className="hidden size-11 shrink-0 items-center justify-center rounded-lg bg-primary/10 text-primary transition-colors group-hover:bg-primary/20 @xs:flex">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      <span className="font-(family-name:--font-bricolage) text-base font-semibold tracking-tight transition-colors group-hover:text-primary @sm:text-lg">
                        {job.title}
                      </span>
              ...
              <div className="flex flex-col gap-3 border-t border-border/50 px-4 py-3 @sm:flex-row @sm:flex-wrap @sm:items-center @sm:px-5">
                ...
                <div className="flex items-center gap-3 @sm:ml-auto">
                  ...
                  <Button
                    size="sm"
                    className="rounded-full bg-primary px-5 text-white transition-all hover:bg-primary/90 group-hover:shadow-md"
                  >
                    Details
