                  ...
                  <div className="min-w-0 flex-1 space-y-1">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {application.profile?.openToWork && (
                        <Badge
                          variant="outline"
                          className="gap-1 rounded-full border-primary/30 bg-primary/10 px-2 py-0 text-[10px] font-medium text-primary"
                        >
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            {application.profile!.skills.map((skill) => (
                              <Badge
                                key={skill}
                                variant="outline"
                                className="rounded-full border-primary/20 bg-primary/5 px-2.5 py-0.5 text-[11px] text-primary"
                              >
                                {skill}
                              </Badge>
                            ))}
