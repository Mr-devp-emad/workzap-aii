  ...
  return (
    <section className="animate-fade-in space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        {canManage && (
          <Button asChild size="sm" className="rounded-full bg-secondary text-white hover:bg-secondary/90">
      ...
      <div className="flex border-b border-border">
        ...
        >
          ...
          <span className={`rounded-full px-1.5 py-0.5 text-[11px] leading-none ${
            tab === "active" ? "bg-primary/10 text-primary" : "bg-secondary text-muted-foreground"
          }`}>
            {activeJobs.length}
          </span>
        </button>
        ...
        <Card className="warm-shadow">
          <CardContent className="flex flex-col items-center gap-3 py-12 text-center">
            <div className="flex size-12 items-center justify-center rounded-full bg-secondary/10">
              <BriefcaseBusiness className="size-5 text-secondary" />
            </div>
            ...
            {tab === "active" && canManage && (
              <Button asChild className="mt-2 rounded-full bg-secondary text-white hover:bg-secondary/90">
                <Link href="/company/jobs/new">
                  <Plus className="mr-1.5 size-3.5" />
                  Post your first job
                </Link>
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    {application.profile?.openToWork && (
                      <Badge className="gap-0.5 rounded-full bg-primary/10 px-1.5 py-0 text-[10px] font-medium text-primary border-primary/20" variant="outline">
                          ...
                          <div className="flex flex-wrap gap-1">
                            {application.profile!.skills.map((skill) => (
                              <Badge
                                key={skill}
                                variant="outline"
                                className="rounded-full border-primary/20 bg-primary/5 px-2 py-0.5 text-[10px] text-primary"
                              >
                                {skill}
                              </Badge>
                            ))}
                      ...
                      <div>
                        ...
                        <div className="space-y-1 text-sm">
                          ...
                          {application.profile?.linkedinUrl && (
                            <a href={application.profile.linkedinUrl} target="_blank" rel="noreferrer" className="flex items-center gap-1.5 text-primary hover:underline" onClick={(e) => e.stopPropagation()}>
                              <Linkedin className="size-3" /> LinkedIn
                            </a>
                          )}
                          {application.profile?.githubUrl && (
                            <a href={application.profile.githubUrl} target="_blank" rel="noreferrer" className="flex items-center gap-1.5 text-primary hover:underline" onClick={(e) => e.stopPropagation()}>
                              <Github className="size-3" /> GitHub
                            </a>
                          )}
                          {application.profile?.website && (
                            <a href={application.profile.website} target="_blank" rel="noreferrer" className="flex items-center gap-1.5 text-primary hover:underline" onClick={(e) => e.stopPropagation()}>
                      ...
                      {canDecide && application.status !== "withdrawn" && (
                        <div className="space-y-1.5 border-t border-border pt-3">
                          ...
                          <div className="flex flex-col gap-1.5">
                            ...
                            <Button
                              size="sm"
                              className="w-full justify-start rounded-lg bg-primary text-white text-xs hover:bg-primary/90"
