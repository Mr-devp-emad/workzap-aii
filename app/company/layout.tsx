      ...
      <header className="sticky top-0 z-50 border-b border-border/60 bg-background/80 backdrop-blur-lg">
        <div className="mx-auto flex w-full max-w-7xl items-center gap-2 overflow-hidden px-4 py-2.5 md:gap-4 md:px-6 lg:gap-6">
          <div className="flex shrink-0 items-center gap-2 md:gap-2.5">
            <SiteLogo />
            <span
              className="inline-flex shrink-0 items-center rounded-full border-2 border-secondary/30 bg-secondary px-2.5 py-1 text-[10px] font-bold uppercase tracking-wide text-secondary-foreground md:px-3 md:text-xs"
              aria-label="WorkZap Recruiter panel"
            >
              Recruiter
            </span>
          </div>
