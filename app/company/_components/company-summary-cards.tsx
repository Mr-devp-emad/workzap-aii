...
export function CompanySummaryCards({ orgId }: { orgId: string }) {
  ...
  const metrics = [
    { icon: Building2, label: "Organization", value: companyContext.companyName, color: "bg-secondary/10 text-secondary" },
    { icon: Users, label: "Your role", value: companyContext.role, color: "bg-primary/10 text-primary" },
