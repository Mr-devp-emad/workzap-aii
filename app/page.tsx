...
const DECORATIONS = [
  { color: "bg-primary", size: 14, top: "18%", left: "16%", delay: "0.5s" },
  { color: "bg-amber-accent", size: 10, top: "38%", left: "10%", delay: "1.8s" },
  { color: "bg-primary/40", size: 8, top: "10%", right: "16%", delay: "1s" },
  { color: "bg-amber-accent", size: 12, top: "44%", right: "14%", delay: "2.2s" },
  { color: "bg-primary/30", size: 6, top: "28%", left: "22%", delay: "0.3s" },
          ...
          <div className="hidden items-center gap-3 md:flex">
            ...
            <SignedOut>
              ...
              <Button
                asChild
                size="sm"
                className="rounded-full bg-primary px-5 text-sm font-medium text-white hover:bg-primary/90"
              >
          ...
          <div className="border-t border-border/40 bg-background px-6 pb-5 pt-3 md:hidden">
            ...
            <div className="mt-4 flex flex-col gap-2">
              <SignedOut>
                ...
                <Button
                  asChild
                  className="w-full rounded-full bg-primary text-sm font-medium text-white hover:bg-primary/90"
                >
        ...
        <div className="relative z-10 mx-auto max-w-2xl text-center">
          ...
          <div className="@container animate-slide-up stagger-3 mx-auto mt-10 max-w-xl">
            ...
            >
              ...
              <button
                type="submit"
                className="m-2 flex items-center justify-center gap-2 rounded-md bg-primary px-6 py-3 text-sm font-bold tracking-wide text-white uppercase transition-colors hover:bg-primary/90"
              >
          ...
          <div className="relative mt-14 grid gap-12 md:mt-20 md:grid-cols-3 md:gap-0">
            {HOW_IT_WORKS.map((step, i) => (
              <div key={step.title} className="animate-slide-up relative flex flex-col items-center text-center" style={{ animationDelay: `${0.1 + i * 0.12}s` }}>
                ...
                <div className="flex size-14 items-center justify-center rounded-full bg-primary text-white shadow-md">
      ...
      <section className="border-t border-border/40 bg-linear-to-b from-secondary/30 to-background py-16 md:py-24">
        <div className="mx-auto grid max-w-5xl items-center gap-12 px-6 lg:grid-cols-2 lg:gap-16">
                ...
                <div className="rounded-xl border border-border bg-card p-4 warm-shadow">
                  ...
                  <div className="mt-3 space-y-2.5">
                    {[
                      ...
                      { name: "James L.", role: "Frontend Engineer", status: "Accepted", statusColor: "bg-primary/10 text-primary" },
          ...
          <div className="order-1 lg:order-2">
            <span className="inline-flex items-center gap-1.5 rounded-full bg-secondary/10 px-3 py-1 text-xs font-semibold tracking-wide text-secondary uppercase">
            ...
            <ul className="mt-8 space-y-4">
              <li className="flex items-start gap-3">
                <span className="mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-lg bg-secondary/10 text-secondary">
            ...
            <div className="mt-8 flex items-center gap-3">
              <Button
                asChild
                className="rounded-full bg-secondary px-6 text-white hover:bg-secondary/90"
              >
                <Link href="/company">
                  Company workspace
                  <ArrowRight className="ml-2 size-4" />
      ...
      <section className="border-t border-border/40 bg-foreground py-16 text-background md:py-24">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-lg text-background/60">
            Whether you&apos;re looking for your next role or hiring for your team, WorkZap
      ...
      <footer className="border-t border-border/40 bg-background">
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-6 px-6 py-10 md:flex-row md:justify-between">
          ...
          <p className="text-xs text-muted-foreground/60">
            &copy; {new Date().getFullYear()} WorkZap
          </p>
        </div>
      </footer>
    </main>
